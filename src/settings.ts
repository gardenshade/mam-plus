...
class Settings {
    ...
    private static _buildTable ( page: SettingGlobObject ): Promise<string> {
        ...
        return new Promise( resolve => {
            ...
            outp += '<tr><td class="row1" colspan="2"><div id="mp_submit" class="mp_settingBtn">Save M+ Settings??</div><div id="mp_copy" class="mp_settingBtn">Copy Settings</div><div id="mp_inject" class="mp_settingBtn">Paste Settings</div><span class="mp_savestate" style="opacity:0">Saved!</span></td></tr></tbody>'
                ...
                .then( ( r ) => {
                    ...
                    this._getScopes( settings )
                        ...
                        .then( ( scopes ) => {
                            ...
                            const copyBtn: HTMLDivElement = <HTMLDivElement> document.querySelector( '#mp_copy' )!;
                            const pasteBtn: HTMLDivElement = <HTMLDivElement> document.querySelector( '#mp_inject' )!;
                            let ssTimer: number;
                            try {
